...
namespace DataUtilities.Serializer
{
    ...
    public class Serializer
    {
        ...
        /// </summary>
        public void SerializeObject<T>(ISerializable<T> v) where T : ISerializable<T> => v.Serialize(this);
        ...
        /// </summary>
        public void SerializeArray<T>(ISerializable<T>[] v, INTEGER_TYPE length = INTEGER_TYPE.INT32) where T : ISerializable<T>
        {
            SerializeArrayLength(length, v.Length);
            for (int i = 0; i < v.Length; i++)
            { SerializeObject(v[i]); }
        ...
        /// </typeparam>
        public void SerializeArray<T>(T[] v, INTEGER_TYPE length = INTEGER_TYPE.INT32)
        {
        ...
        /// </summary>
        /// <exception cref="NotImplementedException"></exception>
        public void SerializeArray<T>(IEnumerable<ISerializable<T>> v) where T : ISerializable<T>
        {
            TypeSerializer<T> method = GetSerializerForType<T>();
            SerializeArray(v, (s, item) =>
            {
                item.Serialize(s);
            });
        }
        ...
        /// </typeparam>
        /// <exception cref="NotImplementedException"></exception>
        public void SerializeArray<T>(IEnumerable<T> v, Action<Serializer, T> callback)
        {
            int length = 0;
        ...
        /// <exception cref="NotImplementedException"></exception>
        public void SerializeArray<T>(IEnumerable<T> v)
        {
            TypeSerializer<T> method = GetSerializerForType<T>();
            SerializeArray(v, (s, item) =>
            {
